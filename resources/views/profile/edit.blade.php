...
<style>
    ...
    .profile-card { background: var(--ses-bg); border-radius: var(--ses-radius-md); border: 1px solid var(--ses-border); padding: 1.75rem 1.85rem; margin-bottom: 1.35rem; max-width: 680px; box-shadow: var(--ses-shadow-sm); }
    ...
    .ses-input { width: 100%; height: 40px; border: 1.5px solid var(--ses-border); border-radius: var(--ses-radius-sm); padding: 0 12px; font-size: 0.87rem; font-family: 'DM Sans', system-ui, sans-serif; color: var(--ses-gray-900); background: var(--ses-beige); outline: none; transition: border-color 0.15s, box-shadow 0.15s; }
    .ses-input:focus { border-color: rgba(196, 61, 61, 0.45); background: white; box-shadow: 0 0 0 3px rgba(196, 61, 61, 0.08); }
    ...
    .ses-textarea { width: 100%; border: 1.5px solid var(--ses-border); border-radius: var(--ses-radius-sm); padding: 10px 12px; font-size: 0.87rem; font-family: 'DM Sans', system-ui, sans-serif; color: var(--ses-gray-900); background: var(--ses-beige); outline: none; resize: vertical; transition: border-color 0.15s, box-shadow 0.15s; }
    ...
    .btn-save:hover { background: var(--ses-red-hover); }
