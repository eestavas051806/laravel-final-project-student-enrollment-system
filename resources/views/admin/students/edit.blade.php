...
<style>
    ...
    .section-head { font-size: 0.68rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.12em; color: var(--ses-red); padding-bottom: 0.6rem; border-bottom: 1.5px solid #fecaca; margin: 1.25rem 0 0.85rem; }
    ...
    .ses-textarea:focus { border-color: var(--ses-red); background: white; }
